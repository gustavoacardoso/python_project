...
from willylistapp import views, apis
...
urlpatterns = [
    ...
    url(r'^restaurant/meal/edit/(?P<meal_id>\d+)/$', views.restaurant_edit_meal, name = 'restaurant-edit-meal'), # \d+ is for passing numbers
    ...
    # /revoke-token (sign out)
     url(r'^api/restaurant/order/notification/(?P<last_request_time>.+)/$', apis.restaurant_order_notification), # .+ is for passing strings
