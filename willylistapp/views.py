...
from willylistapp.forms import UserForm, RestaurantForm, UserFormForEdit, MealForm
from django.contrib.auth import authenticate, login

from django.contrib.auth.models import User
from willylistapp.models import Meal, Order, Driver
...
def restaurant_report(request):
    ...
    ).order_by("-total_order")[:3] # brings the total of 3 top orders
